    ...
    <section id="why" className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl tracking-tight mb-3">
            <span className="gradient-text font-display">새로운 방식으로</span>
            <br />
            <span className="font-reggae text-[#FFF8F0]">アニメを楽しむ</span>
          </h2>
          <p className="text-[#FFF8F0]/65 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {ITEMS.map((item, i) => (
            ...
            >
              ...
              <h3 className="text-2xl mb-1.5 font-reggae text-[#FFF8F0]">
                {item.jp}
              </h3>
              <div className="text-sm text-[#F4A261] mb-4 tracking-wider uppercase font-bold">{item.ko}</div>
              <p className="text-[#FFF8F0]/75 leading-relaxed text-sm">
                {item.desc}
              </p>

              <div className="mt-6 pt-4 border-t border-[#F4A261]/15 flex items-center gap-2 text-sm text-[#F4A261]/70 group-hover:text-[#F4A261] transition-colors">
                詳しく見る
